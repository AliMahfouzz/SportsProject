        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
          <div class="d-flex flex-column flex-lg-row align-items-center  m-0">
            <ul class="navbar-nav  ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="reservedevents.php">Reserved Events</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="subscriptionlist.php">Subscriptions</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="subscriptions.php">Reserved Subscriptions</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="usersequipments.php">Users equiment</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="buyequipment.php">Buy equiment</a>
              </li>
            </ul>
          </div>
